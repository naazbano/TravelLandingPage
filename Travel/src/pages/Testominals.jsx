...
//             Testimonials
//           </p>
//           <h2 className="text-3xl font-bold text-gray-900 leading-snug mt-2">
...
//           {/* Top Card */}
//           <div className="bg-white shadow-lg rounded-lg p-6 max-w-md z-20 relative">
//             <div className="flex items-center mb-4">
//               <img src={asstes.mikeTaylor} alt="Mike Taylor" className="w-12 h-12 rounded-full" />
//               <div className="ml-4">
...
//           <div className="bg-white shadow-lg rounded-lg  p-6 max-w-md absolute top-25 left-20   z-10 opacity-70">
//             <div className="flex items-center mb-4">
...
//       {/* Logos */}
//       <div className="flex flex-wrap justify-evenly items-center gap-2 mt-30">
//         <img src={asstes.axon} alt="Axon" className="h-20 w-25" />
//         <img src={asstes.Jetstar} alt="Jetstar" className="h-20 w-25" />
//         <img src={asstes.expedia
//         } alt="Expedia" className="h-30 w-35 relative top-9" />
//         <img src={asstes.qantas} alt="Qantas" className="h-8" />
//         <img src={asstes.alitalia} alt="Alitalia" className="h-8" />
//       </div>

//       {/* Subscribe Section */}
//       <div className="bg-purple-50 rounded-tl-4xl rounded-lg px-6 py-10 mt-16 max-w-4xl mx-auto relative">
...
//             className="px-4 py-2 rounded-l-lg border border-gray-300 text-black w-64 focus:outline-none"
//           />
//           <button className="bg-orange-400 hover:bg-orange-500 text-white px-6 py-2 rounded-r-lg">
//             Subscribe
//           </button>
//         </div>
//         <div className="absolute  -right-0.5 -top-0.5 ">
//           <button className="absolute right-6 top-6 bg-purple-500 text-white p-3 rounded-full">
//            <FaPaperPlane />
//           </button>
//         </div>
//       </div>
